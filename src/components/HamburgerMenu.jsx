...
const Hamburger = ({ toggleMenu }) => {
  ...
  return (
    <>
      <div
        ref={menuRef}
        className="fixed top-0 left-0 flex flex-col justify-center w-screen h-full px-6 overflow-hidden text-black bg-white sm:px-12 gap-14"
      >
        <div className="flex flex-col items-center justify-center w-full gap-3">
          <Link
            ...
            duration={500}
            onClick={toggleMenu}
            className="sm:text-[35px] text-[25px] w-full cursor-pointer "
          >
